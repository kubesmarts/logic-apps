...
|Byte-identical Helm copy of the MODE 1 config (rendered into a ConfigMap). Drift is guarded by `VectorConfigValidationIT.helmChartConfigsMatchCollectorSources`.

|`data-index/helm/data-index/configs/vector/vector-mode2-elasticsearch.yaml`
|Byte-identical Helm copy of the MODE 2 config.

...
5. ✓ FluentBit DaemonSet deployment and configuration
...
[source,text]
----
Quarkus Flow → stdout → K8s logs → FluentBit → Elasticsearch (raw)
                                                      ↓
                                            ES Transform (1s)
                                                      ↓
...
[STEP] Deploying FluentBit (Elasticsearch mode)...
[INFO] ✓ FluentBit deployed

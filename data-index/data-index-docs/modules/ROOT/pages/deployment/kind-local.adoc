...
3. Initializes database schema (Flyway migrations)
...
1. Generates FluentBit ConfigMap from source files:
   - `mode1-postgresql-triggers/fluent-bit.conf`
   - `mode1-postgresql-triggers/parsers.conf`
   - `mode1-postgresql-triggers/flatten-event.lua`
...
4. Triggers normalize events to workflow_instances and task_instances
...
[source,text]
----
[INFO] Testing MODE 1 (PostgreSQL Triggers) end-to-end
...
[INFO] ========================================
[INFO] MODE 1 End-to-End Test: PASSED
[INFO] ========================================
----

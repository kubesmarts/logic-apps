...
Common issues and solutions when integrating **Quarkus Flow workflow applications** with Data Index.

[IMPORTANT]
====
This guide is for **Quarkus Flow app developers** integrating their workflow applications with Data Index. If you're developing Data Index itself, see the contributor documentation.
====
